...
def process_song_data(spark, input_data, output_data):
    ...
    artists_table = df.select('artist_id', 'artist_name', 'artist_location', 'artist_latitude', 'artist_logitude')
    
    # write artists table to parquet files
    artists_table.write.parquet(output_dat + "artists")
...
def process_log_data(spark, input_data, output_data):
    ...
    # read log data file
    df = spark.read.json(log_dat, schema = log_dataset_schema)
